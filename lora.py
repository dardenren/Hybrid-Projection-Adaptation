...
class LoRAConv2d(ConvLoRA):
    def __init__(self, *args, **kwargs):
        super(nn.Conv2d, self).__init__(nn.Conv2d, *args, **kwargs)

class LoRAConv1d(ConvLoRA):
    def __init__(self, *args, **kwargs):
        super(nn.Conv1d, self).__init__(nn.Conv1d, *args, **kwargs)

# Can Extend to other ones like this

class LoRAConv3d(ConvLoRA):
    def __init__(self, *args, **kwargs):
        super(nn.Conv3d, self).__init__(nn.Conv3d, *args, **kwargs)
